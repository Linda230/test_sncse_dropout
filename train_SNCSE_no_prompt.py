...
class DataTrainingArguments:
    ...
    train_file: Optional[str] = field(
        default=r"data/wiki1m_for_simcse.txt",
    ...
    def prepare_features(examples):
        ...
        if Negation:
            ...
            for idx in range(total):
                ...
                negation_sample.append(negation_sentence)

            sentences += negation_sample
...
if __name__ == "__main__":
    ...
    file_path = r"./data/soft_negative_samples.txt"
    negation = dict()
    f = open(file_path)
    for line in f:
